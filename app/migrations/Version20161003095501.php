 ...
 */
class Version20161003095501 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER VIEW appliancesfordealers AS select a.id, a.id as offer_id, a.is_read, ca.id as appliance_id, a.state, IFNULL(a.created, CURRENT_TIMESTAMP) as created, cl.name as clientName, cl.email as clientEmail, cl.city as city, cl.position as clientPosition, ca.brand, ca.model, ca.derivative, ca.transmission, ca.motor_type, ca.number_of_doors, ca.price, ca.package, ca.extras, ca.color, ca.number_of_offers, ca.vehicle_id, a.dealer_id, d.name as dealer_name from carappliances as ca
